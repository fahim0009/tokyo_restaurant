                          ...
                          <div style="display: flex;">
                            <div>
                                <img class="imgPreview img img-circle"
                                 width="80" src="@if (!empty($company->company_logo)){{asset('company/'.$company->company_logo)}}@endif">
                            </div>
                            ...
                            <div style="display: flex;">
                                <div>
                                    <img class="imgPreviews img img-circle"
                                     width="80" src="@if (!empty($company->fav_icon)){{asset('company/'.$company->fav_icon)}}@endif">
                                </div>
                                <div style="margin-left: 15px; flex-grow: 1">
                                    <p>Choose a file</p>
