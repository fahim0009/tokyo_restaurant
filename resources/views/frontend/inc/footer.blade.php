<footer class="ftco-footer">
                ...
                <div class="ftco-footer-widget">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="#"><span class="fa fa-phone mr-3"></span><span class="text">+{{\App\Models\CompanyDetail::first()->phone1}}</span></a></li>
    ...
    <div class="container"><center>
            <div class="copyright text-white">Copyright  © 2022<strong>
                    <span>Home X Contracting Corp  </span></strong>All Rights Reserved
